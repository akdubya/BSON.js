var common = require('./bson_common'),
    BSON = module.exports,
...
var OrderedHash = BSON.OrderedHash,
    Binary = BSON.Binary,
    DBRef = BSON.DBRef;
...
BSON.encodeDBRef = function(dbref) {
  ...
  ordered_values.add('$ref', dbref.ref);
  ordered_values.add('$id', dbref.id);
